...
# Il est recommandé de garder processed/ et graphs/ dans le même dossier que le script
input_folder = r"processed"                # dossier contenant les CSV *_datatest_clean.csv
graphs_folder = os.path.join(input_folder, "graphs")
os.makedirs(graphs_folder, exist_ok=True)

# Charger tous les fichiers *_datatest_clean.csv
