...
# Il est recommandé de garder raw_logs/ et processed/ dans le même dossier que le script
input_folder = r"processed"                # dossier contenant les CSV nettoyés (_log_clean.csv)
